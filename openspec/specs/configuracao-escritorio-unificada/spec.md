# configuracao-escritorio-unificada

## Purpose

Configuração unificada do escritório em `/settings`: perfil institucional, CNPJ controlado, credencial canônica e-CNPJ A1, vínculos de finalidade, consentimento versionado e alertas de certificado no painel.
