# Outbound Xml Recovery Orchestration

## Purpose

Orquestração idempotente entre chave descoberta, recuperação SVRS, ingestão documental, retentativas, bloqueios e fallback assistido.
