# seed-admin-plataforma-demo

## Purpose

Fixture local/testing do administrador global demo (`PlatformAdminDemoSeeder`): identidade estável exclusivamente global, idempotência, falha sem escalada e massa de Offices limitada a Plataforma e Contador Genérico.
