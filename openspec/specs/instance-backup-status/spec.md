...
Registro e exposição do estado de backup da instância (full/database/vault), restore drill e alertas de atraso, sem incluir chave mestra nem material sensível.
