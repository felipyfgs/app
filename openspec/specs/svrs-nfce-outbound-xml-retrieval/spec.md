# Svrs Nfce Outbound Xml Retrieval

## Purpose

Recuperação gratuita de nfeProc de NFC-e 65 (MA) por chave conhecida e A1 via portal oficial SVRS (HTTP+mTLS), com parser estrito, validação fiscal, resiliência e flags de rollout.
