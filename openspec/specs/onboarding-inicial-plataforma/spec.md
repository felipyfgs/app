...
Onboarding inicial fail-closed da instalação: status/conclusão públicos controlados por flag e token de deploy, criação do primeiro administrador global sem Office e fechamento permanente da superfície.
