# MA Outbound XML Retrieval

## Purpose

Recuperação oficial de XML de NF-e/NFC-e de saída no Maranhão via pacote SEFAZ-MA (assistido) e, quando autorizado, contrato M2M — sem automação de portal humano.
