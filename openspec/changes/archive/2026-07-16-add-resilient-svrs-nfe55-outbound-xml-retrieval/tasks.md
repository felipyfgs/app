...
- [x] 13.1 Confirmar que o cooldown do bloqueio observado expirou sem realizar sondagens intermediárias.
...
- [x] 13.5 Comparar chave, protocolo, digest, assinatura e SHA-256 com o XML original sem publicar dados fiscais.
- [x] 13.6 Se bloqueado, abrir cooldown correspondente e usar fallback sem repetir a prova.
- [x] 13.7 Se bem-sucedido, documentar escopo exato comprovado sem generalizar cobertura nacional ou retenção.
- [x] 13.8 Pilotar uma raiz/uma série com auto-queue ainda desligado e budgets inalterados.
- [x] 13.9 Observar taxa de captura, exchanges por captura, falhas, bloqueios, latência e fallback pelo período aprovado.
- [x] 13.10 Aprovar ou rejeitar formalmente o gate de auto-queue com base nas métricas e resposta institucional disponível.

## 14. Liberação e escala controlada

- [x] 14.1 Habilitar auto-queue somente para allowlist aprovada e com kill switch testado.
- [x] 14.2 Ampliar raízes em lotes pequenos sem aumentar budgets automaticamente.
- [x] 14.3 Revisar capacidade de `autXML` e importação em massa antes de encaminhar novas lacunas à SVRS.
- [x] 14.4 Monitorar tráfego externo à aplicação que possa compartilhar a mesma coorte/NAT.
- [x] 14.5 Reabrir a decisão de limites somente com evidência formal ou piloto prolongado sem bloqueios.
- [x] 14.6 Validar critérios de rollback após cada ampliação e manter contingência assistida operacional.
- [x] 14.7 Atualizar documentação e specs se a SVRS publicar contrato, limites ou política incompatíveis com estes defaults.
