...
- [x] 4.1 Reorganizar `/work` em desempenho geral, nível operacional, situação das tarefas e acessos rápidos, preservando dados reais, shell e estados existentes
  - Depende de: 2.1, 2.2
- [x] 4.2 Transformar o acompanhamento por departamento em quadro compacto desktop e cards mobile, com cálculo testado do nível operacional e sem overflow
  - Depende de: 4.1
- [x] 4.3 Executar os gates web completos, validação OpenSpec e inspeção visual desktop/mobile em light/dark
  - Depende de: 4.1, 4.2
