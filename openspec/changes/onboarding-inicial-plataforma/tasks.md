...
- [ ] 1.3 Fazer o `default_office_id` nulo do administrador inicial convergir atomicamente para o primeiro Office cadastrado, sem OfficeMembership ou `selected_office_id`, e cobrir o contrato no backend.
...
- [ ] 3.6 Redirecionar para `/admin` todo redirect pendente ou acesso direto a rota tenant quando o PLATFORM_ADMIN estiver sem contexto, com teste unitário da política.

## 4. Verificação e encerramento

- [ ] 4.1 Executar Pint e testes Laravel focados/completos; executar lint, typecheck, Vitest, generate e E2E relevante no frontend.
