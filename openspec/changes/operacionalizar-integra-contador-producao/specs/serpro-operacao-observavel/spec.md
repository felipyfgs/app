...
Ações sensíveis, mudanças de gate, rotação, consentimento, assinatura, aceite, aprovação, kill switch e conciliação MUST produzir auditoria append-only com ator, 2FA, tempo, motivo, versão e hash encadeado ou armazenamento imutável equivalente. Segredos e XML bruto MUST ser excluídos do evento.
