    ...
    public function resolveForModule(FiscalModuleKey $module, ?string $submodule = null): MonitoringSurfaceContract
    {
        ...
        $key = match ($module) {
            ...
            FiscalModuleKey::SimplesMei => match ($sub) {
                'PGDASD', 'PGDAS-D', 'SIMPLES', 'SIMPLES_NACIONAL' => 'simples_mei_pgdasd',
                'PGMEI', 'MEI' => 'simples_mei_pgmei',
                'DASN_SIMEI', 'DASN-SIMEI', 'DASN' => 'simples_mei_dasn',
                'REGIME' => 'simples_mei_regime',
                default => 'simples_mei_pgdasd',
            },
    ...
    private function buildContracts(array $index): array
    {
        $list = [
            ...
            new MonitoringSurfaceContract(
                ...
                responsibility: 'Dívida ativa e DAS do MEI',
                channel: MonitoringChannel::Integra,
                operationKeys: [
                    'pgmei.dividaativa',
                    'pgmei.gerardaspdf',
            ...
            new MonitoringSurfaceContract(
                ...
                routePattern: '/monitoring/simples-mei/dasn-simei',
                responsibility: 'Declarar explicitamente a indisponibilidade atual de DASN-SIMEI',
                channel: MonitoringChannel::Integra,
                operationKeys: [
                ...
                officialState: MonitoringOfficialStateSummary::Prospection,
                resultKind: MonitoringResultKind::Unavailable,
                allowsDocument: false,
                documentPolicy: MonitoringDocumentPolicy::Never,
                sourceLabel: 'DASN-SIMEI',
            ),
            new MonitoringSurfaceContract(
                surfaceKey: 'simples_mei_regime',
                routePattern: '/monitoring/simples-mei/regime',
                responsibility: 'Opção e resolução do regime de apuração',
                channel: MonitoringChannel::Integra,
                operationKeys: [
                ...
                allowsDocument: true,
                documentPolicy: MonitoringDocumentPolicy::WhenArtifact,
                sourceLabel: 'Regime de apuração',
            ),
            new MonitoringSurfaceContract(
                surfaceKey: 'dctfweb',
